...
var G__41234 = devtools.prefs.pref.call(null,v);
v = G__41234;
continue;
} else {
return v;
...
}catch (e41237){var _e__40918__auto__ = e41237;
return false;
}})();
...
}catch (e41241){var _e__40918__auto__ = e41241;
return false;
}})();
...
}catch (e41243){var _e__40918__auto__ = e41243;
return false;
}}
}
});
...
var vec__41245 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__41245,(0),null);
var name = cljs.core.nth.call(null,vec__41245,(1),null);
...
return cljs.core.some.call(null,(function (p1__41248_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41248_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1510806288478
