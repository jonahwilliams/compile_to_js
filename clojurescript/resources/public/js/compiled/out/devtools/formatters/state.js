...
var len__31375__auto___41254 = arguments.length;
var i__31376__auto___41255 = (0);
while(true){
if((i__31376__auto___41255 < len__31375__auto___41254)){
args__31382__auto__.push((arguments[i__31376__auto___41255]));

var G__41256 = (i__31376__auto___41255 + (1));
i__31376__auto___41255 = G__41256;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq41252){
var G__41253 = cljs.core.first.call(null,seq41252);
var seq41252__$1 = cljs.core.next.call(null,seq41252);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__41253,seq41252__$1);
});
...
return (p1__41257_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1510806288515
