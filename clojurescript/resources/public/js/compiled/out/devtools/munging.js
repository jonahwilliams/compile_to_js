...
var o41132 = temp__5455__auto__;
var temp__5455__auto____$1 = (o41132["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o41133 = temp__5455__auto____$1;
return (o41133["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40911__auto__ = f;
return (o__40911__auto__["toString"]).call(o__40911__auto__);
} else {
return "";
}
}catch (e41134){var _ = e41134;
return "";
}});
...
try{var o__40911__auto___41136 = t;
(o__40911__auto___41136["cljs$lang$ctorPrWriter"]).call(o__40911__auto___41136,t,writer);
}catch (e41135){var __41137 = e41135;
}
...
var char_code = (function (){var o__40911__auto__ = (new String(char$));
return (o__40911__auto__["charCodeAt"]).call(o__40911__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40911__auto__ = String;
return (o__40911__auto__["fromCharCode"]).call(o__40911__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41138 = num_code;
switch (G__41138) {
case (1):
return (185);
...
var o__40911__auto__ = String;
return (o__40911__auto__["fromCharCode"]).call(o__40911__auto__,superscript_code);
});
/**
...
}catch (e41140){var _e__40918__auto__ = e41140;
return false;
}})())){
...
var vec__41141 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__41141,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o41144 = temp__5455__auto__;
var temp__5455__auto____$1 = (o41144["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o41145 = temp__5455__auto____$1;
return (o41145["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31375__auto___41152 = arguments.length;
var i__31376__auto___41153 = (0);
while(true){
if((i__31376__auto___41153 < len__31375__auto___41152)){
args__31382__auto__.push((arguments[i__31376__auto___41153]));

var G__41154 = (i__31376__auto___41153 + (1));
i__31376__auto___41153 = G__41154;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41148){
var vec__41149 = p__41148;
var ns_detector = cljs.core.nth.call(null,vec__41149,(0),null);
...
var G__41155 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__41156 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__41155;
remaining_tokens = G__41156;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41146){
var G__41147 = cljs.core.first.call(null,seq41146);
var seq41146__$1 = cljs.core.next.call(null,seq41146);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__41147,seq41146__$1);
});
...
var vec__41160 = cljs.core.split_with.call(null,(function (p1__41159_SHARP_){
return cljs.core.not_EQ_.call(null,p1__41159_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__41160,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__41160,(1),null);
...
var vec__41163 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__41163,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__41163,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__41166 = cljs.core.rest.call(null,remaining_tokens);
var G__41167 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__41166;
name_tokens = G__41167;
continue;
} else {
...
var vec__41170 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__41170,(0),null);
var arity = cljs.core.nth.call(null,vec__41170,(1),null);
var vec__41173 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__41173,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__41173,(1),null);
var vec__41176 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__41176,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__41176,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__41176,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__41176,(3),null);
...
var vec__41182 = result;
var munged_ns = cljs.core.nth.call(null,vec__41182,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__41182,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__41182,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__41182,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__41182,(4),null);
var arity = cljs.core.nth.call(null,vec__41182,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__41186 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__41186,(0),null);
var args = cljs.core.nth.call(null,vec__41186,(1),null);
var vec__41189 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__41189,(0),null);
var name = cljs.core.nth.call(null,vec__41189,(1),null);
...
var G__41192 = (arity + (1));
var G__41193 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41194){
var vec__41195 = p__41194;
var arity = cljs.core.nth.call(null,vec__41195,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__41195,(1),null);
...
return cljs.core.get.call(null,arities,p1__41198_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__41199_SHARP_);
...
var args__31382__auto__ = [];
var len__31375__auto___41206 = arguments.length;
var i__31376__auto___41207 = (0);
while(true){
if((i__31376__auto___41207 < len__31375__auto___41206)){
args__31382__auto__.push((arguments[i__31376__auto___41207]));

var G__41208 = (i__31376__auto___41207 + (1));
i__31376__auto___41207 = G__41208;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41202){
var vec__41203 = p__41202;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__41203,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41200){
var G__41201 = cljs.core.first.call(null,seq41200);
var seq41200__$1 = cljs.core.next.call(null,seq41200);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__41201,seq41200__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__41211__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__41211__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__41211__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__41211__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41212 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__41212,(0),null);
var fn_name = cljs.core.nth.call(null,vec__41212,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__41212,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__41212,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__41212,(4),null);
var arity = cljs.core.nth.call(null,vec__41212,(5),null);
...
var o__40911__auto__ = f;
return (o__40911__auto__["getBasis"]).call(o__40911__auto__);
});
/**
...
}catch (e41216){var _e__40918__auto__ = e41216;
...
var G__41217 = (obj[cljs.core.first.call(null,path)]);
var G__41218 = cljs.core.rest.call(null,path);
obj = G__41217;
path = G__41218;
continue;
} else {
...
return (function (accum,p__41219){
var vec__41220 = p__41219;
var bit = cljs.core.nth.call(null,vec__41220,(0),null);
var protocol = cljs.core.nth.call(null,vec__41220,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41223){
var vec__41224 = p__41223;
var ns = cljs.core.nth.call(null,vec__41224,(0),null);
var name = cljs.core.nth.call(null,vec__41224,(1),null);
var selector = cljs.core.nth.call(null,vec__41224,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__41229,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__41229,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__41229,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__41227_SHARP_){
return (obj[cljs.core.first.call(null,p1__41227_SHARP_)]);
});})(name,sorted_matches,vec__41229,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1510806288367
