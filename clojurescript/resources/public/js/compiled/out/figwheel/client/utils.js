...
return (new CustomEvent(event_name,(function (){var obj36652 = {"detail":data};
return obj36652;
})()));
} else {
...
var f = (function (){var pred__36659 = cljs.core._EQ_;
var expr__36660 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36659.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36660))){
return ((function (pred__36659,expr__36660){
return (function (p1__36653_SHARP_){
return console.warn(p1__36653_SHARP_);
});
;})(pred__36659,expr__36660))
} else {
if(cljs.core.truth_(pred__36659.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36660))){
return ((function (pred__36659,expr__36660){
return (function (p1__36654_SHARP_){
return console.debug(p1__36654_SHARP_);
});
;})(pred__36659,expr__36660))
} else {
if(cljs.core.truth_(pred__36659.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36660))){
return ((function (pred__36659,expr__36660){
return (function (p1__36655_SHARP_){
return console.error(p1__36655_SHARP_);
});
;})(pred__36659,expr__36660))
} else {
return ((function (pred__36659,expr__36660){
return (function (p1__36656_SHARP_){
return console.log(p1__36656_SHARP_);
});
;})(pred__36659,expr__36660))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36663){
...
var eval_fn = cljs.core.get.call(null,map__36664__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36666_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__36668,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1510806281177
