...
$c_Ltutorial_webapp_HelloWorldApp$.prototype.main__AT__V = (function(args) {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body.appendChild($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createTextNode("Hello, World"))
});
...
$m_Ltutorial_webapp_HelloWorldApp$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
